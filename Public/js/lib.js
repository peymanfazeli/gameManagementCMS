 ...
 * @return {String} game.xsd xml {@link https://cdn.jsdelivr.net/gh/aut-archive/ie@master/2016/fall/HW-3/schema/game.xsd}
 */
...
/**
 * Make level.xml
 * @param {String} request {@link https://cdn.jsdelivr.net/gh/aut-archive/ie@master/2016/fall/HW-3/schema/new_game.xsd}
 * @param {Function} [cb] - cb(xmlStr)
 * @return {String} level.xsd xml {@link https://cdn.jsdelivr.net/gh/aut-archive/ie@master/2016/fall/HW-3/schema/game.xsd}
 */
function getNewGame(request, cb) {
  // Parse opts
  var _request = new DOMParser().parseFromString(request, "text/xml")
    .childNodes[0];
  ...
  for (var r = 0; r < opts.rows; r++) {
    var row = [];
    for (var c = 0; c < opts.cols; c++) row.push(undefined);
    game.push(row);
  }
